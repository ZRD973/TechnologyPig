...
<script>
    import mrpzxCheckerBox from '../../components/mrpzx-checker-box/mrpzx-checker-box';
    import mrpzxCheckerItem from '../../components/mrpzx-checker-item/mrpzx-checker-item'
    export default {
        components:{
            mrpzxCheckerBox,mrpzxCheckerItem
        },
        data() {
            return {
                type: 'radio',
